...
function BloodFinder() {
    ...
    const searchBlood = (e) => {
        ...
        axios
            ...
            .catch((err) => {
                setError('Failed to fetch blood inventory. Please try again later.');
            });
    };
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                            <div className="w-full">
                                <form onSubmit={searchBlood}>
                                    ...
                                    <div className="mt-8">
                                        <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
                                    </div>
                                </form>
                                <div>
                                    ...
                                    {matchingBlood.length > 0 ? (
                                        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                            <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                                <tr>
                                                    <th scope="col" className="px-6 py-4 text-center">Donor ID</th>
                                                    <th scope="col" className="px-6 py-4 text-center">Unit Size</th>
                                                    <th scope="col" className="px-6 py-4 text-center">Expiration Date</th>
                                                    <th scope="col" className="px-6 py-4 text-center">Availability</th>
