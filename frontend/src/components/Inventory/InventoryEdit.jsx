        ...
        <div className="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 p-6">
                ...
                <form onSubmit={updateInventory} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        className="mr-4 text-white bg-blue-700 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-blue-600 dark:focus:ring-red-900"
                    >
                        Update Inventory
                    </button>
                    {(userRole === 'admin' || userRole === 'manager') && (
                        <button
                            ...
                            className="ml-4 text-white bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-red-600 dark:focus:ring-red-900"
                        >
                            Delete Inventory
                        </button>
                    )}
